...
//        loginInputLayoutPassword = (TextInputLayout) findViewById(R.id.login_input_layout_password);
        ...
        btnLinkToSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(pizzavengers.ca.dal.com.fitfood.LoginActivity.this, SignupActivity.class);
                ...
                .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            UID = user.getUid();
                            //////////////////////////////////
                            dataExchange.setUID(UID);
                            //////////////////////////////////
                            Intent intent = new Intent(LoginActivity.this, CalculateStatsActivity.class);

                            //intent.putExtra("TESTIDLogin",UID);
                            startActivity(intent);
                            finish();
                        }
                    }
